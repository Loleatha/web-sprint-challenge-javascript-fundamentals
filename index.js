...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*Nested function and internal both lay within the function "myFunction." Anything within "myFunction" is considered to be inside of the lexical environment, which gives the nested function the go-to to reach out and grab that variable.*/
...
const zooAnimals = [
  ...
  */
  ...
  let USApop = zooAnimals.reduce((total, animal) => {
